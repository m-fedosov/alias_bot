...
class Team:
    ...
    Атрибут points - хранит набранные командой очки

    Атрибут name - хранит название команды
    """
...
class Session:
    ...
    Атрибут dictionary - уникальный список слов для созданной сессии

    Атрибут key - уникальный идентификатор сессии
